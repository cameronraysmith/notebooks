...
# install jupyter
RUN pip install wheel jupyter jupyterlab jupyterlab-git nbresuse jupyterlab-topbar-extension jupyterlab-system-monitor nbgitpuller jupyterhub jupytext RISE voila
